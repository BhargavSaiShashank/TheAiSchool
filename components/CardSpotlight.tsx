...
export default function CardSpotlight({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative overflow-hidden rounded-lg group h-full bg-zinc-950/20 border border-zinc-900 hover:border-[#7C5CFF]/30 transition-all duration-300">
