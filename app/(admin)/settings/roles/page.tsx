      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage your organization members, invite new teammates, and configure access levels.
          </p>
        </div>
      </div>
        ...
        <OrganizationProfile
          appearance={{
            ...
            elements: {
              ...
              navbarButton: "text-muted-foreground hover:bg-secondary hover:text-foreground",
              pageScrollBox: "p-4 sm:p-8",
              headerTitle: "text-foreground",
              headerSubtitle: "text-muted-foreground",
              profileSectionTitleText: "text-foreground font-semibold",
              profileSectionPrimaryButton: "text-[#7C5CFF] hover:bg-[#7C5CFF]/10",
