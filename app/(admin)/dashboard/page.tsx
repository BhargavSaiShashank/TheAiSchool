...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const dismissed =
        localStorage.getItem("pulsesend:onboarding_completed") === "true";
  ...
  const stats = [
    {
      ...
      value: liveStats.totalAudience,
      sub: "Active subscribers",
      icon: Users,
      accent: "text-[#7C5CFF]",
      borderAccent: "hover:border-[#7C5CFF]/30",
    },
    {
      label: "Emails Dispatched",
      value: liveStats.totalDispatched,
      sub: "Lifetime sends",
      icon: Send,
      accent: "text-[#7C5CFF]",
      borderAccent: "hover:border-[#7C5CFF]/30",
    },
    {
      ...
      sub: "Total open weight",
      icon: MailOpen,
      accent: "text-emerald-400",
      borderAccent: "hover:border-emerald-900/40",
    },
    {
      label: "Avg. Click Rate",
      value: liveStats.clickRate,
      sub: "Unique clicks",
    ...
    },
    {
      ...
      value: liveStats.deliverability,
      sub: "ISP validated status",
      icon: ShieldCheck,
      accent: "text-[#7C5CFF]",
      borderAccent: "hover:border-[#7C5CFF]/30",
    },
    {
      ...
      borderAccent: "hover:border-amber-900/40",
    },
  ];
  ...
  const aiInsights = [
    {
      ...
      bg: "insight-amber",
      message:
        parseFloat(liveStats.bounceRate) > 2.0
          ? "Bounce rate elevated! Limit suppressions and verify email syntax."
          : "All sending parameters optimal — compliance levels at super high standards.",
    },
    {
      icon: Zap,
      color: "text-[#7C5CFF]",
      bg: "insight-purple",
      message:
        "SES pipeline initialized in eu-north-1 — fully verified DKIM signatures.",
    },
    {
      icon: ShieldCheck,
      ...
      bg: "insight-green",
      message:
        "Reputation score healthy. Safe sending envelope actively maintained.",
    },
  ];
    ...
    <div className="space-y-5 select-none">
            ...
            >
              ...
              <div className="p-4 bg-[#06070a]/95 border border-[#7C5CFF] rounded-lg shadow-[0_12px_40px_rgba(124,92,255,0.18)] max-w-xs backdrop-blur-md">
                ...
                <p className="text-[11px] text-zinc-300 leading-relaxed">
                  Click here to access your Contacts Directory. You can manage
                  lists, add new contacts manually, or upload CSV files!
                </p>
              </div>
            </motion.div>
          )}
          ...
          {onboardingStep === 2 && (
            ...
            >
              ...
              <div className="p-4 bg-[#06070a]/95 border border-[#7C5CFF] rounded-lg shadow-[0_12px_40px_rgba(124,92,255,0.18)] max-w-xs backdrop-blur-md">
                ...
                <p className="text-[11px] text-zinc-300 leading-relaxed">
                  Upload CSV spreadsheets, manage duplicates, and map columns on
                  import in seconds!
                </p>
              </div>
            </motion.div>
          ...
          {onboardingStep === 3 && (
            ...
            >
              ...
              <div className="p-4 bg-[#06070a]/95 border border-[#7C5CFF] rounded-lg shadow-[0_12px_40px_rgba(124,92,255,0.18)] max-w-xs backdrop-blur-md">
                ...
                <p className="text-[11px] text-zinc-300 leading-relaxed">
                  Ready to send? Click here to open the step-by-step Campaign
                  Wizard, select templates, and send real-time tests!
                </p>
              </div>
              {/* Arrow */}
              ...
              <div className="space-y-2 flex-1 relative z-10">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex gap-1">
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${onboardingStep >= 1 ? "bg-[#7C5CFF]" : "bg-zinc-800"}`}
                    />
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${onboardingStep >= 2 ? "bg-[#7C5CFF]" : "bg-zinc-800"}`}
                    />
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${onboardingStep >= 3 ? "bg-[#7C5CFF]" : "bg-zinc-800"}`}
                    />
                  </div>
                </div>
                ...
                <h3 className="text-sm font-bold text-white tracking-tight">
                  {onboardingStep === 1 &&
                    "📋 Step 1: Create Your First Mailing List"}
                  {onboardingStep === 2 &&
                ...
                <p className="text-xs text-zinc-400 max-w-xl leading-relaxed">
                  {onboardingStep === 1 &&
                    "Mailing lists allow you to group contacts and target specific subsets of your audience. Let's create your first segment to get started."}
                  {onboardingStep === 2 &&
                    "Manually add a test subscriber or upload a CSV file with our Tactile Mapping Wizard."}
                  {onboardingStep === 3 &&
                    "Draft your campaign content, select your target lists, choose an HTML template, and test AWS SES sending in seconds."}
                </p>
              </div>
              ...
              <CardSpotlight>
                <div className="p-4 flex flex-col justify-between h-full w-full relative z-10">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <stat.icon
                      className={`w-3.5 h-3.5 shrink-0 ${stat.accent} opacity-70 group-hover:opacity-100 transition duration-300 ${glowClass}`}
                    />
                  </div>
                  <div>
                    <p
                      className={`text-2xl font-black font-mono tracking-tight leading-none ${stat.accent} ${glowClass}`}
                    >
                      {stat.value}
                    </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {aiInsights.map((insight, i) => (
          <div
            key={i}
            className={`flex items-start gap-3 p-3.5 rounded-lg border ${insight.bg}`}
          >
            <insight.icon
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-muted-foreground truncate mt-0.5">
                        <span className="text-[#7C5CFF] font-bold uppercase text-[10px] font-mono mr-1">
                          {act.type}
                        </span>
                        {act.campaign}
                      </p>
      ...
      <div className="p-5 glass-hud rounded-lg">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-4">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground mt-0.5 font-medium">
              Best performing pipelines by engagement rate
            </p>
          </div>
          <Link href="/campaigns">
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="border-b border-border">
                  {[
                    ...
                    <th
                      key={h}
                      className="py-2.5 px-3 text-[11px] font-bold text-muted-foreground font-mono uppercase tracking-wider first:pl-0 last:text-right"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody>
                {topCampaigns.map((camp) => (
                  <tr
                    key={camp.id}
                    className="border-b border-border/50 hover:bg-secondary/20 transition duration-150 group"
                  >
            ...
            <div className="flex items-center gap-2.5 mb-4 relative z-10">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground font-medium">
                  Generate optimized email drafts on demand
                </p>
              </div>
            </div>
              ...
              {copilotResponse && (
                ...
                >
                  <div className="flex justify-between items-center pb-2 border-b border-border">
                    <span className="font-bold text-[#7C5CFF] uppercase tracking-wide text-[10px] text-glow-cyber">
                      🧠 Copilot Draft
                    </span>
                    <span className="text-muted-foreground text-[10px]">
                      Audience: {copilotResponse.audience}
                    </span>
                  </div>
                  <div>
                    <p className="text-muted-foreground text-[10px] uppercase font-bold mb-1">
                      Subject
                    </p>
                    <p className="text-foreground font-bold">
                      {copilotResponse.subject}
                    </p>
                  </div>
                  <div>
                    <p className="text-muted-foreground text-[10px] uppercase font-bold mb-1">
                    ...
                    <p className="text-foreground/90 whitespace-pre-wrap bg-secondary/50 p-3 rounded border border-border leading-relaxed">
                      {copilotResponse.body}
                    </p>
                  </div>
                  <Link
                    href={`/campaigns?new=true&subject=${encodeURIComponent(copilotResponse.subject)}&body=${encodeURIComponent(copilotResponse.body)}`}
                  >
